		...
		<main>
			<div class="container">
				<div class="breadcrumbs">
					...
					<span class="breadcrumbs-item"><a class="breadcrumbs-item-link">Поиск по запросу «<?php echo $search; ?>»</a></span>		
				</div>
				...
				<div class="sort">
					...
					<ul class="sorting-list">
						<li><a href="search.php?sort=default&q=<?php echo $search; ?>">По популярности</a></li>
						<li><a href="search.php?sort=price-asc&q=<?php echo $search; ?>">По возрастанию цены</a></li>
						<li><a href="search.php?sort=price-desc&q='<?php echo $search; ?>">По убыванию цены</a></li>
					</ul>
				</div>

				<div class="row no-gutters">
<?php
					$rows = $link->query("SELECT * FROM products, categories WHERE (products.productTitle like '%$search%' or categories.categoryName like '%$search%') and (categories.categoryID = products.productCategory and productVisible = 1) GROUP BY products.productID");
...
echo ('
					<div class="message-container">
						<span class="message-title">По вашему запросу ничего не найдено</span>
