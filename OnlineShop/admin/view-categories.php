...
<html>
	...
	<body>
		...
		<main>
			<div class="container">
				<?php 
					$rows = mysqli_query($link, "SELECT * FROM products $querytype WHERE productCategory = $category");
...
echo('
							<div class="my-card col-lg-3 col-md-6">
								...
								<div class="card-subtitle">
									...
									<span class="card-delete-categories red" pID='.$row["productID"].' pTYPE='.$row["productCategory"].'>Удалить <i class="fas fa-trash-alt"></i></span>
								</div>
							</div>
');
						}
